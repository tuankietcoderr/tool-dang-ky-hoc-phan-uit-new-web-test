/**
 * this is copied from {@link https://github.com/loia5tqd001/Dang-Ky-Hoc-Phan-UIT/blob/master/react/src/views/1ChonFileExcel/utils.ts}
 * @author loia5tqd001 {@link https://github.com/loia5tqd001}
 */

export function arrayToTkbObject(array: any[]) {
  // convert excel based date (1989-Dec-30) to Js based date (1970-Jan-01)
  function convertExcelDateToStringDate(excelDate: any) {
